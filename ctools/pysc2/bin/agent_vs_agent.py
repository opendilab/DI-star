...
$ python -m ctools.pysc2.bin.agent_vs_agent --server --map AbyssalReef --agent tstarbot.agents.zerg_agent.ZergAgent --agent_race zerg
...
from ctools.pysc2.env import lan_sc2_env
#from ctools.pysc2.env import run_loop
from ctools.pysc2.env import sc2_env, lan_server_sc2_env
from ctools.pysc2.lib import point_flag
