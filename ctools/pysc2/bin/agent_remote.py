...
To play on ladder:
  $ python -m ctools.pysc2.bin.agent_remote --agent <import path> \
      --host_port <GamePort> --lan_port <StartPort>

To play vs humans:
  $ python -m ctools.pysc2.bin.agent_remote --human --map <MapName>
...
from ctools.pysc2.env import remote_sc2_env
