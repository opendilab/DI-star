...
import sys
from ctools.pysc2.lib import sc_process
from ctools.pysc2.run_configs import platforms
from ctools.pysc2.run_configs import lib
...
def get(version=None):
  ...
  if True:  # due to not using flags
