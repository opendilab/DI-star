...
class NaturalTime(BaseTime):
    ...
    Example:
        >>> from ctools.utils.autolog.time_ctl import NaturalTime
        >>> time_ = NaturalTime()
    """
...
class TickTime(BaseTime):
    ...
    Example:
        >>> from ctools.utils.autolog.time_ctl import TickTime
        >>> time_ = TickTime()
    """
...
class TimeProxy(BaseTime):
    ...
    Example:
        >>> from ctools.utils.autolog.time_ctl import TickTime, TimeProxy
        >>> tick_time_ = TickTime()
