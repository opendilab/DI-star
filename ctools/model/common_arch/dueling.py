...
from ctools.torch_utils import fc_block
...
class DuelingHead(nn.Module):
    ...
    Notes:
        ...
        The other two major improvements are double DQN and prioritized replay, which in ctools \
    ...
    def __init__(
        ...
        Arguments:
            ...
            - norm_type (:obj:`str`): the type of normalization to use, see ctools.torch_utils.fc_block for more details
        """
