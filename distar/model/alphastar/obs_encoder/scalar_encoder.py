...
from ctools.torch_utils import fc_block, build_activation, one_hot
...
class ScalarEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        immediate_cum_stat_data = self.immediate_cumulative_stat.data if 'immediate_cumulative_stat' in self.keys else None
        return embedded_scalar, scalar_context, baseline_feature, cum_stat_data, immediate_cum_stat_data
