...
from distar.ctools.utils import read_file, save_file

logger = logging.getLogger('default_logger')


def build_checkpoint_helper(cfg=None):
    r"""
    Overview:
...
class CheckpointHelper(object):
    ...
    def _load_matched_model_state_dict(self, model, ckpt_state_dict, info_print):
        r"""
        Overview:
    ...
    def load(
        ...
        if strict:
            ...
            self._load_matched_model_state_dict(model, state_dict, info_print)
        ...
        try:
            ...
            print(f"Error:{e}; Can't load optimizer parameter")
