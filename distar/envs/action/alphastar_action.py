...
from ctools.pysc2.lib.static_data import NUM_ACTIONS, ACTIONS_REORDER, ACTIONS_REORDER_INV
from ctools.pysc2.lib.action_dict import GENERAL_ACTION_INFO_MASK, ACT_TO_GENERAL_ACT
from ctools.torch_utils import to_tensor, tensor_to_list
    ...
    def _init(self, cfg):
        ...
        self._template = {
            'action_type':
            {
                ...
                'env_value': 'categorial value, refer to ctools.pysc2.lib.action_dict',
