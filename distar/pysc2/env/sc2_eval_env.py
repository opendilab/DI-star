...
from distar.pysc2.lib import actions as actions_lib, renderer_human
...
from distar.pysc2.env.sc2_env import Agent, Bot
...
class SC2EVALEnv(environment.Base):
    ...
    def step(self, actions, step_mul=None):
        ...
        for c, f, o, a in zip(self._controllers, self._features, self._obs, actions):
            if not type(a) == list:  # a single command, must be distar.ctools.pysc2 func-call action
