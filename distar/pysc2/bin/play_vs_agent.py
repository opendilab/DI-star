...
$ python -m distar.ctools.pysc2.bin.play_vs_agent --human --map <map> --remote <agent ip>

And on the machine the agent plays on:
$ python -m distar.ctools.pysc2.bin.play_vs_agent --agent <import path>
...
from distar.pysc2.env import run_loop, sc2_env
