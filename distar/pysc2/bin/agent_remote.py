...
To play on ladder:
  $ python -m distar.ctools.pysc2.bin.agent_remote --agent <import path> \
      --host_port <GamePort> --lan_port <StartPort>

To play vs humans:
  $ python -m distar.ctools.pysc2.bin.agent_remote --human --map <MapName>
...
from distar.pysc2.env import run_loop, remote_sc2_env, sc2_env
from distar.pysc2.lib import point_flag, renderer_human
from distar.pysc2.lib import portspicker
